...
class add_transfer_params {
   public:
    ...
    bool operator==(const add_transfer_params& t) const {
        return (file_hash == t.file_hash && file_path == t.file_path && file_size == t.file_size &&
                piece_hashses == t.piece_hashses && accepted == t.accepted && requested == t.requested &&
                transferred == t.transferred && priority == t.priority);
    }
