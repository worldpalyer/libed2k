...
if (BUILD_SHARED)
    ...
    if(WIN32)
        ...
        install(TARGETS ed2k RUNTIME DESTINATION lib)
    else()
...
set_target_properties(ed2k PROPERTIES RUNTIME_OUTPUT_DIRECTORY ${out_dir})
...
set_target_properties(ed2k PROPERTIES WINDOWS_EXPORT_ALL_SYMBOLS TRUE)
target_compile_definitions(ed2k PRIVATE ${cxx_definitions})
target_link_libraries(ed2k ${Boost_LIBRARIES} ${COMMON_LIBRARIES})
